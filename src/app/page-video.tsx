    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          {/* Video Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-slate-800/70 to-indigo-900/60"></div>
        </div>

        {/* Hero Content */}
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4 py-24">
          <div className="mb-8">
            <p className="text-sm font-semibold text-indigo-300 uppercase tracking-wider mb-6 opacity-90">
              新事業チーム診断サービス
            </p>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight">
              あなたのチームの<br />
              新規事業構想力、<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-300 italic">
                &ldquo;見える化&rdquo;
              </span><br />
              しませんか？
            </h1>
          </div>
          <p className="text-xl md:text-2xl text-gray-200 mb-6 max-w-4xl mx-auto font-light leading-loose opacity-90">
            新事業開発に取り組むチームの能力を客観的に診断
          </p>
          <p className="text-base text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed opacity-80">
          ...
          <a 
            ...
            className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 backdrop-blur-sm"
          >
            7分で完了！新事業チーム診断（無料）
          </a>
        </div>
