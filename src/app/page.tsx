    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-24 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-6">
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-4">新事業チーム診断サービス</p>
            <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-6 leading-tight">
              あなたのチームの<br />新規事業構想力、<br />
              <span className="text-blue-600 italic">&ldquo;見える化&rdquo;</span><br />しませんか？
            </h1>
          </div>
          <p className="text-2xl md:text-3xl text-gray-700 mb-4 max-w-4xl mx-auto font-light leading-relaxed">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-red-500 uppercase tracking-wider mb-4">よくある課題</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              新規事業開発で<br />こんな<em className="text-red-500 not-italic">課題</em>はありませんか？
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-8 bg-red-50 rounded-xl border-l-4 border-red-500 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-center p-8 bg-orange-50 rounded-xl border-l-4 border-orange-500 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-center p-8 bg-yellow-50 rounded-xl border-l-4 border-yellow-500 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="text-center mt-16">
            <div className="bg-blue-600 text-white p-8 rounded-2xl shadow-lg max-w-4xl mx-auto">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-4">簡単3ステップ</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              診断サービスの<br /><em className="text-blue-600 not-italic">3ステップ</em>
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6 shadow-lg">
                1
              </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-green-600 uppercase tracking-wider mb-4">診断の価値</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              診断で得られる<br /><em className="text-green-600 not-italic">メリット</em>
            </h2>
          </div>
      ...
      <section className="py-20 px-4 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-4">実際の声</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              お客様の<em className="text-blue-600 not-italic">声</em>
            </h2>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-6">今すぐ始める</p>
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-8 leading-tight">
            まずは<em className="text-blue-600 not-italic">無料診断</em>で、<br />貴社チームの現在地を<br />把握しませんか？
          </h2>
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-sm font-semibold text-blue-400 uppercase tracking-wider mb-6">私たちについて</p>
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            <em className="text-blue-400 not-italic">NEWh</em>について
          </h2>
